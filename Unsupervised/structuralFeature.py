...
class structuralFeature:
    def __init__(self):
        ...
        #################################
        # Drawing whole plots
        # self._draw_plot('0902_2018_222_001')
    ...
    def _draw_plot(self, input_key: str):
        ...
        with open(data_path) as csvfile:
            ...
            for row in readCSV:
                key = row[0]
                if (key != 'key' and input_key == '') or (key != 'key' and input_key == key):
    ...
    def _get_data(self):
        ...
        with open(path) as csvfile:
            ...
            for row in readCSV:
                time_window = row[0]
                if time_window == '0209_2018_223_004':
                    print('hi')
